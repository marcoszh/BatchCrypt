    ...
    def fit(self, data_instances, validate_data=None):
        ...
        for iter_num in range(self.max_iter):
            ...
            for train_x, train_y in self.zcl_dataset:
                ...
                self.transfer_variable.guest_grad.remote(obj=grads.for_remote(), role=consts.ARBITER, idx=0, suffix=(iter_num, batch_num))
                LOGGER.info("Sent grads")
                self.transfer_variable.guest_loss.remote(obj=loss_value, role=consts.ARBITER, idx=0, suffix=(iter_num, batch_num))
