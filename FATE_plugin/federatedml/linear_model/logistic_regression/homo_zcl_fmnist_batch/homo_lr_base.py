...
from federatedml.transfer_variable.transfer_class.homo_zcl_alex_transfer_variable import HomoZclAlexTransferVariable
...
class HomoLRBase(BaseLogisticRegression):
    ...
    def _init_model(self, params):
        ...
        self.transfer_variable = HomoZclAlexTransferVariable()
